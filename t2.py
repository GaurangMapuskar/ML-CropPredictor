...
def prediction():
    ...
    duration = "4-5 months"
    season = "Febuary-March"
    rain = "500mm"
    # crop = PhotoImage(file="C:\\Users\\ASUS\\Desktop\\wheat.png")
    ...
    my_text = Label (master, text="AGRO-TECH", font=("Arial",20), fg="GREEN")
    my_text.pack(padx=20,pady=20,)
    '''
    # create a canvas
    my_canvas = Canvas(master, width=800, height=500)
    ...
    # add a label
    my_canvas.create_text(760, 50, text="Crop Prediction", font=("Arial", 45))
    # my_canvas.create_image(200,200,image=crop)

    label = Label(my_canvas, image=bg, height=200, width=200)
    label.place(x=640, y=100)

    my_canvas.create_text(760, 350, text="Name of Crop :" + crop_name + "", font=("Arial", 45))

    my_canvas.create_text(360, 450, text="Duration of Crop yeild : ", font=("Arial", 25))
    my_canvas.create_text(660, 450, text=duration, font=("Arial", 25))
    my_canvas.create_text(360, 550, text="Best Season : ", font=("Arial", 25))
    my_canvas.create_text(660, 550, text=season, font=("Arial", 25))
    my_canvas.create_text(360, 650, text="Minimum rainfall :", font=("Arial", 25))
    my_canvas.create_text(660, 650, text=rain, font=("Arial", 25))

    button = Tk.Button(my_canvas, height=10, width=30, text="Yield Prediction", font=("Arial", 16))
    button.place(x=1060, y=450)
...
'''def number(self):
        ...
        t1=int(entry_widget1.get())
        t2=int(entry_widget2.get())
        t3=int(entry_widget3.get())
        t4=int(entry_widget4.get())
        t5=int(entry_widget5.get())
        t5=int(entry_widget6.get())
        t6=int(entry_widget7.get())

def predict():
    content1 = content1_value.get()
    content2 = content2_value.get()
    content3 = content3_value.get()
    content4 = content4_value.get()
    content5 = content5_value.get()
    content6 = content6_value.get()
    content7 = content7_value.get()

    if content1 == "":
        messagebox.showerror("Please enter content1")
    elif content2 == "":
        messagebox.showerror("Please enter content2")
    elif content3 == "":
        messagebox.showerror("Please enter content3")
    elif content4 == "":
        messagebox.showerror("Please enter content4")
    elif content5 == "":
        messagebox.showerror("Please enter content5")
    elif content6 == "":
        messagebox.showerror("Please enter content6")
    elif content7 == "":
        messagebox.showerror("Please enter content7")
    else:
        my_canvas.create_text(750, 800, text="Predicting Wait....", font=("Arial", 20))'''
...
button1 = Button(root, text="Predict", font=("Times New Roman", 25),command=button)
button1_window = my_canvas.create_window(750, 700, window=button1)
button2 = Button(root, text="Back", font=("Times New Roman", 10))
